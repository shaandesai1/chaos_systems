...
%\begin{figure*}[ht!]
%\includegraphics[width=\textwidth]{figures/damped_rollout.pdf}
%%\includegraphics[width=\textwidth]{figures/damped_contour.pdf}
%\caption{Damped mass spring rollout of an initial condition sampled from the test set. Only TDHNN4 and baseline are able to evolve the initial condition with TDHNN4 also being able to recover the damping term.}
%\end{figure*}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.4\textwidth]{figures/duffing_state.pdf}
\includegraphics[width=0.48\textwidth]{figures/dpdt_duffing.pdf}
\includegraphics[width=0.48\textwidth]{figures/duffing_errors.pdf}
%TDHNN4_duffing_1.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.4\textwidth]{figures/relativity_pred.pdf}
\includegraphics[width=0.48\textwidth]{figures/dpdt_relativity.pdf}
\includegraphics[width=0.48\textwidth]{figures/relativity_errors.pdf}
