...
for noise_val in noise_var:
    ...
    train_data = get_dataset(dataset_name, n_train_traj, T_max, dt, noise_std=noise_val, seed=0,type=type_vec)
    valid_data = get_dataset(dataset_name, n_test_traj, T_max_t, dt, noise_std=0, seed=14,type=type_vec)
